...
# ── Pipeline logic ────────────────────────────────────────────────────────────
async def run_pipeline(job_id: int, keywords: list[str], max_per_keyword: int):
...
- Price: €{product.get('cost_eur', '?')} cost → €{product.get('sell_price_eur', '?')} sell ({product.get('margin_pct', '?')}% margin)
...
def _mock_products(keywords: list) -> list:
    ...
    mock = []
    samples = [
        {"title": "无线蓝牙耳机5.0降噪超长续航", "title_translated": "Wireless Bluetooth Earphones 5.0 Noise Cancel Long Battery", "price_cny": 28, "orders": 4521, "rating": 4.7, "category": "Electronics"},
        {"title": "磁吸手机支架桌面懒人支撑架", "title_translated": "Magnetic Phone Stand Desktop Lazy Holder", "price_cny": 12, "orders": 8234, "rating": 4.8, "category": "Phone Accessories"},
        {"title": "简约陶瓷马克杯咖啡杯办公室", "title_translated": "Minimalist Ceramic Mug Coffee Cup Office", "price_cny": 18, "orders": 3102, "rating": 4.9, "category": "Home"},
        {"title": "LED氛围灯USB桌面小夜灯", "title_translated": "LED Ambient Light USB Desktop Night Light", "price_cny": 22, "orders": 6780, "rating": 4.6, "category": "Home Decor"},
        {"title": "皮质笔记本手账日记本", "title_translated": "Leather Notebook Journal Diary", "price_cny": 35, "orders": 2890, "rating": 4.8, "category": "Stationery"},
        {"title": "多功能收纳盒桌面整理", "title_translated": "Multi-function Storage Box Desktop Organizer", "price_cny": 25, "orders": 5430, "rating": 4.7, "category": "Home"},
        {"title": "硅胶手机壳防摔保护套", "title_translated": "Silicone Phone Case Anti-drop Protective Cover", "price_cny": 8, "orders": 12000, "rating": 4.5, "category": "Phone Cases"},
        {"title": "编织手提包托特包女", "title_translated": "Woven Tote Bag Shoulder Bag Women", "price_cny": 45, "orders": 1890, "rating": 4.8, "category": "Bags"},
        {"title": "香薰蜡烛礼盒套装", "title_translated": "Aromatherapy Candle Gift Box Set", "price_cny": 38, "orders": 3210, "rating": 4.9, "category": "Home Fragrance"},
        {"title": "ins风干花相框装饰画", "title_translated": "Instagram Style Dried Flower Photo Frame Wall Art", "price_cny": 42, "orders": 2100, "rating": 4.7, "category": "Home Decor"},
        {"title": "折叠收纳袋旅行分装袋", "title_translated": "Foldable Storage Bag Travel Organizer", "price_cny": 15, "orders": 7650, "rating": 4.6, "category": "Travel"},
        {"title": "批发工厂直销手机配件低价", "title_translated": "Wholesale Factory Direct Phone Accessories Cheap", "price_cny": 3, "orders": 50, "rating": 3.8, "category": "Spam"},
        {"title": "木质桌面摆件创意装饰品", "title_translated": "Wooden Desktop Ornament Creative Decoration", "price_cny": 29, "orders": 4320, "rating": 4.8, "category": "Home Decor"},
    ]
    import random
    for kw in keywords:
...
async def post_approved_products(product_ids: list[int]):
    """Placeholder — integrate with instagrapi or Buffer API here."""
